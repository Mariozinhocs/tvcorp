# Script de Deploy de Homologação (/hml) via FTP - TvCorp
...
Write-Host "Iniciando deploy do TvCorp em Homologação (/hml)..." -ForegroundColor Green
$baseUri = "$ftpServer$remotePath"

# 1. Estrutura de Diretórios
Create-FtpDirectory -uri "$baseUri"
...
Write-Host "`nDeploy de Homologação Finalizado!" -ForegroundColor Green
